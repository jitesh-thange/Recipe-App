...
public class SimilarRecipeAdapter extends RecyclerView.Adapter<SimilarRecipeViewHolder>{
    ...
    public void onBindViewHolder(@NonNull SimilarRecipeViewHolder holder, int position) {
        holder.textView_similar_titel.setText(list.get(position).title);
        holder.textView_similar_titel.setSelected(true);
        ...
        holder.similer_recipe_holder.setOnClickListener(new View.OnClickListener() {
            @Override
...
class SimilarRecipeViewHolder extends RecyclerView.ViewHolder{
    CardView similer_recipe_holder;
    TextView textView_similar_titel,textView_similar_serving;
    ...
    public SimilarRecipeViewHolder(@NonNull View itemView) {
        ...
        similer_recipe_holder =itemView.findViewById(R.id.similer_recipe_holder);
        textView_similar_titel =itemView.findViewById(R.id.textView_similar_titel);
